...
const HeroSection =()=>{
    return(
        <section id="home" className="text-gray-900 body-font bg-gray-200">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <Animation />
      <a className="flex justify-center mt-8" href="https://drive.google.com/file/d/1yPxUMHEq2YehTF0jJ4HVEOZfzqovk94B/view?usp=share_link">
